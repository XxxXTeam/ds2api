...
const EMPTY_OUTPUT_RETRY_SUFFIX = 'Предыдущий ответ не содержал видимого вывода. Сейчас сгенерируй видимый финальный ответ на китайском языке или вызов инструмента.';
